	      ...
	      <div class="col-xs-9 col-xs-offset-3 col-md-10 col-md-offset-2 main">
			...
			<input type="hidden" name="cid" value="${cstm.cid }"/>
	          ...
	          <div class="form-group">
	            ...
	            required="required" title="请输入客户姓名" value="${cstm.cname }">
	          </div>
	          <!-- 性别  -->
	          <div class="form-group">
	          ...
	          <div class="form-group">
	            ...
	            <input type="date" name="birthday" id="birthday" class="form-control col-xs-3 col-md-4"
	            value="${cstm.birthday }">
	          </div>
	          <!-- 手机  -->
	          <div class="form-group">
	            ...
	            value="${cstm.cellphone }">
	          </div>
	          <!-- 邮箱  -->
	          <div class="form-group">
	            <label for="email" class="col-xs-3 col-md-2 control-label">邮箱</label>
	            <input type="email" name="email" id="email" class="form-control col-xs-3 col-md-4"
	             required="required" value="${cstm.email }">
	          </div>
	          <!-- 描述  -->
	          <div class="form-group">
	            <label for="description" class="col-xs-3 col-md-2 control-label">描述</label>
